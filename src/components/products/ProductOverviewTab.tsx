      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-base font-mono text-gray-900">{product.code}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-base text-gray-900">{product.trial_days} ngày</p>
          </div>
          ...
          <div>
            ...
            <p className="text-base text-gray-900">{product.display_order}</p>
          </div>
          ...
          <div>
            ...
            <Badge className={product.is_featured ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-600'}>
          ...
          <div>
            ...
            <p className="text-sm font-mono text-gray-600">{product._id}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">v{product.version}</p>
            </div>
          </div>
          ...
          {product.created_by && (
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-mono text-gray-600">{product.created_by}</p>
              </div>
            </div>
          )}
          ...
          {product.updated_by && (
            <div className="flex items-start gap-3">
              <Tag className="w-5 h-5 text-gray-400 mt-0.5" />
              <div>
                <p className="text-sm font-medium text-gray-900">Cập nhật bởi</p>
                <p className="text-sm font-mono text-gray-600">{product.updated_by}</p>
              </div>
            </div>
          )}
        </div>
