 ...
 * List and manage registration telemetry data
 */

import React, { useState, useEffect } from 'react';
import { useTranslation } from 'react-i18next';
import { useNavigate } from 'react-router-dom';
import { Plus, RefreshCw, Search, Download, Calendar } from 'lucide-react';
import {
...
export default function UserRegistrationTelemetryPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm(t('userRegistration.deleteConfirm'))) return;
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={() => navigate('/core/user-registration-telemetry/new')}>
