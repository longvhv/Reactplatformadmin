...
const InvoiceDetailPage: React.FC = () => {
  ...
  const loadInvoice = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        showToast.error(t('invoices.errors.notFound'));
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      showToast.success(t('invoices.sendSuccess'));
      loadInvoice();
    } catch (error) {
      console.error('Error sending invoice:', error);
      showToast.error(t('invoices.errors.sendFailed'));
    }
  };
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <div className="mt-6">
            <Button onClick={() => navigate('/commerce/subscription-invoices')}>
              {t('common.back')}
            </Button>
          </div>
        </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="ghost" onClick={() => navigate('/commerce/subscription-invoices')}>
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline" onClick={() => navigate(`/commerce/subscription-invoices/edit/${invoice._id}`)}>
