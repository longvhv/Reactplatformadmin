 ...
 * ✅ UPDATED: Used components from /components/tenant-subscriptions
 */
...
import { CreditCard, ArrowLeft, Edit, Trash2, MoreVertical, Calendar, Users, HardDrive } from 'lucide-react';
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="entitlements">
             <SubscriptionEntitlementsTab 
               ...
               subscription={{
                 granted_entitlements: data.limits || {},
                 granted_app_codes: data.features || []
               }}
             />
          </TabsContent>

          <TabsContent value="history">
            <SubscriptionHistoryTab subscriptionId={data._id} />
          </TabsContent>
        </Tabs>
      </PageLayout>
